			...
			<div class="flex flex-col w-full px-[80px] md:px-[20px]">
				...
				<div class="grid grid-cols-3 gap-4 w-full">
					<div class="grid gap-2">
						<Div_image img_url={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/index/contents/image003.png"} />
						<Div_image img_url={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/index/contents/image004.png"} />
					</div>

					<div class="grid gap-2">
						<Div_image img_url={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/index/contents/image005.png"} />
						<Div_image img_url={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/index/contents/image001.png"} />
					</div>
	
					<div class="grid gap-2">
						<Div_image img_url={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/index/contents/image002.png"} />
						<Div_image img_url={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/index/contents/image006.png"} />
					</div>
				</div>
			</div>
		)

			...
			<tr class="bg-white border-b">
				<th scope="row" class="flex flex-col px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
					...
					<div class="flex flex-row justify-start items-center w-full space-x-4">
						<p class="text-xs">
							신청일시: {data_waiting[btn_data].created_at}
						</p>
					...
					<div class="flex flex-row justify-start items-center w-full space-x-2">
						<button type="button"
								...
								onClick={() => click_btn_waiting_accept(data_waiting[btn_data].uuid)}>
							승인
						</button>
						<button type="button"
								...
								onClick={() => click_btn_waiting_decline(data_waiting[btn_data].uuid)}>
							거절
						</button>
					</div>
				</th>

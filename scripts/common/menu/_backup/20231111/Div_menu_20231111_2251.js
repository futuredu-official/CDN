function Div_menu() {
	...
	function menu_dropdown_intro() {
		...
		if (!toggle_menu_dropdown_intro) {
			...
			toggle_menu_dropdown_intro = true
		} else {
	...
	function menu_dropdown_guide() {
		...
		if (!toggle_menu_dropdown_guide) {
			...
			toggle_menu_dropdown_guide = true
		} else {
			document.getElementById("mega_menu_dropdown_guide").className = "hidden"
			toggle_menu_dropdown_guide = false
		}
			...
			<div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
				...
				<div id="mega_menu_icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
					<ul class="flex flex-col mt-4 text-sm font-medium md:flex-row md:space-x-8 md:mt-0">
						<Div_menu_li_button_single id={"mega_menu_button_futuredu" } text={"온라인 Futuredu"} url={"/online/"}
												   image={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/svg/menu_online.svg"} />

						<Div_menu_li_button_single id={"mega_menu_button_futuredu" } text={"라이센스"} url={"/license/"}
												   image={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/svg/menu_lock.svg"} />
		
						<li class="hover:underline hover:decoration-blue-600 hover:decoration-wavy">
							<Div_menu_li_button_multiple id={"mega_menu_button_guide"} text={"가이드"} func={() => menu_dropdown_guide()}
														 image={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/svg/menu_guide.svg"} />
						...
						<Div_menu_li_button_single id={"mega_menu_button_community" } text={"커뮤니티"} url={"/community/"}
						...
						<li class="hover:underline hover:decoration-blue-600 hover:decoration-wavy">
							<Div_menu_li_button_multiple id={"mega_menu_button_intro"} text={"FuturEdu 소개"} func={() => menu_dropdown_intro()}
														 image={"https://cdn.jsdelivr.net/gh/futuredu-official/CDN/images/svg/menu_intro.svg"} />

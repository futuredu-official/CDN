function click_tab(tab_name) {
	...
	if (tab_name == "slide6" && !toggle_slide6) {
		document.getElementById("slide6").className = class_slide
		toggle_slide6 = true
	} else {
		document.getElementById("slide6").className = "hidden"
		toggle_slide6 = false
	}
}